...
export default function Card({ children, title, footer, glow, className = '' }: CardProps) {
	return (
		<div className={`card-brutal scifi-window p-0 overflow-hidden relative group transition-all duration-300 ${glow ? 'border-neon-cyan/40 bg-neon-cyan/[0.02]' : ''} ${className}`}>
